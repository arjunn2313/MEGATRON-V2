          ...
          <div className="selling-car-wrap">
            ...
            <div className="selling-car">
              <div className="selling-carpart">
                ...
                {/* <div className="carpart">
                  <img
                    src="./assets/images/c/vintage.jpg"
                    alt="Vintage Car"
                    className="car"
                  />
                </div> */}
                  ...
                  <Link href="/#">
                    <div className="inner">
                      <div className="group-title">
                        <div className="title">Car Suspension Disc</div>
                      </div>
              ...
              <div className="selling-content">
                ...
                <p className="des">
                  For 15 years, we raising the standard of used car ret with one
                  of the most innovative and reliable used ve programmes ever
